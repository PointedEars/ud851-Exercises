...
public class NotificationUtils {
    private static final int ID_INTENT_MAIN_ACTIVITY = 1;
    private static final String NOTIFICATION_CHANNEL_ID = "notification_main";
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            // DONE (10) In the _remindUserBecauseCharging_ method use NotificationCompat.Builder to create a notification
            // that:
            ...
            CharSequence text = context.getString(R.string.charging_reminder_notification_body);
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(context, ID_INTENT_MAIN_ACTIVITY, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    }
