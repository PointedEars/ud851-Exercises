...
public class NotificationUtils {
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(
                context, WATER_REMINDER_PENDING_INTENT_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        NotificationCompat.Action action = new NotificationCompat.Action(
             ...
             context.getString(R.string.action_ignore_notification_title), pendingIntent);
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        NotificationCompat.Action action = new NotificationCompat.Action(
                ...
                context.getString(R.string.action_drink_title),
                pendingIntent);
