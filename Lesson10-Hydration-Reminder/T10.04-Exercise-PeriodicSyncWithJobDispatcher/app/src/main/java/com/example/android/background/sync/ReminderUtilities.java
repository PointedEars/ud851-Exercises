...
public class ReminderUtilities {
    ...
    synchronized public static void scheduleChargingReminder(Context context) {
        ...
        if (result == FirebaseJobDispatcher.SCHEDULE_RESULT_SUCCESS) {
            ...
            switch (result) {
                case FirebaseJobDispatcher.SCHEDULE_RESULT_BAD_SERVICE:
                    msg = "Bad service: " + job.getService();
                    break;

                case FirebaseJobDispatcher.SCHEDULE_RESULT_UNKNOWN_ERROR:
                    msg = "Unknown error";
                    break;

                case FirebaseJobDispatcher.SCHEDULE_RESULT_UNSUPPORTED_TRIGGER:
                    msg = "Unsupported trigger: " + job.getTrigger();
                    break;

                default:
                    msg = "Unsupported result: " + result;
            }
