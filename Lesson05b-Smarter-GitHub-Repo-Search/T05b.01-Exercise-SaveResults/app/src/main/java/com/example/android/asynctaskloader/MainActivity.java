...
public class MainActivity extends AppCompatActivity {
    ...
    static final String KEY_QUERY_URL = "queryURL";

    // DONE (2) Create a static final key to store the search's raw JSON
    static final String KEY_SEARCH_RESULT = "JSON";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mSearchResultsTextView.setText(savedInstanceState.getString(KEY_SEARCH_RESULT));
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(KEY_SEARCH_RESULT, result);
    }
